...
namespace Microsoft.Build.Utilities.ProjectCreation.NuGet
{
    ...
    public static class ExtensionMethods
    {
        ...
        /// </summary>
        /// <param name="projectCreator">The current <see cref="ProjectCreator" /> to use.</param>
        ...
        public static ProjectCreator ItemPackageReference(this ProjectCreator projectCreator, PackageIdentity package, string includeAssets = null, string excludeAssets = null, string privateAssets = null, IDictionary<string, string> metadata = null, string condition = null, string label = null)
        {
            return projectCreator.ItemPackageReference(package.Id, package.Version.ToNormalizedString(), includeAssets, excludeAssets, privateAssets, metadata, condition, label);
        }
    }
}